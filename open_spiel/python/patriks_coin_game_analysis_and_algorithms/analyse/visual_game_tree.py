# patriks_coin_game_visualization.py
...
FLAGS = flags.FLAGS
flags.DEFINE_string("game", "patriks_coin_game", "Name of the game")
...
def main(argv):
    ...
    # Check if the game is simultaneous and attempt to convert to turn-based
    if game_type.dynamics == pyspiel.GameType.Dynamics.SIMULTANEOUS:
        logging.warning("%s is not turn-based. Trying to reload game as turn-based.", FLAGS.game)
